...
// Handle form  to insert new question
if (isset($_POST['question']) && !empty($_POST['question'])) {
    ...
    $sql = "INSERT INTO faqs (question, name, email) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('sss', $question, $name, $email);

    if ($stmt->execute()) {
        $success_message = "Your question is submitted!";
    } else {
...
<head>
    ...
    <style>
        ...
        input[type="text"], input[type="email"], textarea { width: 100%; padding: 10px; border-radius: 5px; border: 1px solid #ccc; margin-top: 10px; }
...
<body>
    <div class="container">
        ...
        <div class="submit-question">
            ...
            <form action="..\faq\admin.php" method="POST">
